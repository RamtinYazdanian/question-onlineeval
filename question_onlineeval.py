...
def recom_result():
    if request.method == 'POST':
        ...
        resp.set_cookie('final_recoms', json.dumps(final_recoms))
...
def thank_you_page():
    if request.method == 'POST':
        ...
        final_recoms = request.cookies.get('final_recoms')
        ...
        results_to_save_dict['final_recoms'] = json.loads(final_recoms)
